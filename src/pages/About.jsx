      ...
      <div className={styles.row}>
        ...
        <div data-aos="fade-left">
          ...
          <p>
            ...
            ethical and moral values. The IT department is dedicated to uphold
            the following objectives: To develop conceptual and analytical
            skills in all functional areas of Information Technology, provide
            platform of high academic excellence to all students, encourage
            understanding of the strategic perceptions of the fast changing
            global scenario, develop the ability to understand and apply a
            multi-dimensional approach to achieve the overall mission of the
            organization and impart ethical and moral values for social
            well-being.
          </p>
        </div>
      </div>
      ...
      <div className={styles.row}>
        <div data-aos="fade-right">
          ...
          <p>
            ...
            Ignite, the Ignite 2k19 will provide many new opportunities and
