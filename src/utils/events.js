const data = [
  ...
  },
  {
    ...
    data: [
      {
        intro: [
          'It gives a platform to experience the placement event. It will help you to find out what is the placement procedure and where do you stand. Candidates will be participating individually.',
